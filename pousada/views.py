...
class CotacaoCreat(GroupRequiredMixin, CreateView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            kidyears = form.cleaned_data['kidyears']
            ...
            valordosite2 = tafera_service.webdrive(checkin=checkin2, checkout=checkout2, person_num=person_num)
            dialy_of_price = valordosite2
            tarefa_nova = Tarefas(author=author, name=name, tel=tel, checkin=checkin, checkout=checkout,
                                  person_num=person_num, kidquestion=kidquestion, kidyears=kidyears, discount=discount,
